...
const stringCalcMo_1 = require("./stringCalcMo");
describe('StringCalculator', function () {
    let sc;
    beforeEach('create new Object', function () {
        sc = new stringCalcMo_1.StringCalculator();
    });
    describe('addNumbersWithDelimiters', function () {
        it('check sum', function () {
            chai_1.expect(sc.addNumbersWithDelimiters('//[;][||]\n1||1;1', ';|\\|\\|')).to.deep.equal([1, 1, 1]);
        });
    });
    ...
    describe('getDelimiters', function () {
        it('check delimiters', function () {
            chai_1.expect(sc.getDelimiters('//[;][||]\n1||1;1')).to.equal(';|\\|\\|');
            chai_1.expect(sc.getDelimiters('//;\n2;2')).to.equal(';');
        });
    });
